...
public class student_home extends javax.swing.JFrame {
    ...
    public void answerCheck(){
        ...
        int questionnumber = Integer.parseInt(questionid);
        questionnumber += 1;
        questionid = String.valueOf(questionnumber);
        ...
        //At the last question the "next" button will be hidden
    ...
    public void question(){
        try {
            ...
            ResultSet rs1 = st.executeQuery("select * from question_table where qid = '"+questionid+"'");
            while(rs1.next()){
    ...
    public void submit(){
        ...
        try {
            Connection cn = repository.ConnectionDB.getConnectionDB();
            Statement st = cn.createStatement();
            st.executeUpdate("update user_table set marks_secured = '"+marks+"' where roll_no = '"+rollNo+"'");
            String marks1 = String.valueOf(marks);
            
            if(marks > 6){
                JOptionPane.showMessageDialog(this, "Thank you for taking this exam. \n\n You've passed the examination\n\n Your total mark is "+marks1);
                setVisible(false);
                new view.student.student_login().setVisible(true);
            }else{
                JOptionPane.showMessageDialog(this, "Thank you for taking this exam. \n\n Sorry!!! You've failed in the examination\n\n Your total mark is "+marks1);
                setVisible(false);
                new view.student.student_login().setVisible(true);
            }
    ...
    public student_home(String rollNo){
        ...
        Date dt = new Date();
        jLabel8.setText(dFormat.format(dt));

        try {
            Connection cn = repository.ConnectionDB.getConnectionDB();
            Statement st = cn.createStatement();

            ResultSet rs = st.executeQuery("select * from user_table where roll_no = '"+rollNo+"'");
            while(rs.next()){
        ...
        timer = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                jLabel7.setText(String.valueOf(second));
                jLabel6.setText(String.valueOf(minute));
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(204, 204, 169));
        ...
        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/exam_icon.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/submit_icon.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(925, 625));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int a = JOptionPane.showConfirmDialog(null, "Are you sure to submit all the answers?", "Select", JOptionPane.YES_NO_OPTION);
        if(a == 0){
            answerCheck();
            submit();
        }
