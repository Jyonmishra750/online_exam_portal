...
public class admin_forgetpassword extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jPasswordField1, javax.swing.GroupLayout.DEFAULT_SIZE, 560, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(jTextField2.getText().equals(jPasswordField1.getText())){
           boolean b = service.admin.admin_forgetpassword_service.admin_forgetpswd(jTextField1.getText(), jPasswordField1.getText());
           if(b){
                JOptionPane.showMessageDialog(this, "PASSWORD UPDATED SUCCESSFULLY...");
                setVisible(false);
                new admin_login().setVisible(true);
            }else{
                JOptionPane.showMessageDialog(this, "Failed to update your password!!!");
            }
       }else{
